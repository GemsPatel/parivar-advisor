...
function sendMail($toEmail,$subject,$mail_body,$from_email='',$from_name = '',$file_path = '')
{
	...
	if($smtp == TRUE)
	{
		...
		$config['smtp_user'] = 'info@cloudwebs.net';
		$config['smtp_pass'] = '?x*061i5NPh';
...
function sendParivarSMS( $mobiles, $sms_content)
{
	...
	*/
	...
	{ 
		...
		if( $is_mail )
		{
			...
			$headers = "From: kakdiya.gautam288@perrian.com\r\n";
